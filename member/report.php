...
// Get previous month's balance (if any)
$prev_month = date('Y-m', strtotime($month_year . '-01 -1 month'));
$prev_month_with_day = $prev_month . '-01'; // Fixed: Create separate variable
...
$prev_balance_data = mysqli_fetch_assoc($prev_balance_result); // Fixed: Changed from $prev_balance_stmt to $prev_balance_result
                            ...
                            <div class="col-md-6">
                                <table class="table table-sm table-borderless">
                                    <tr>
                                        ...
                                        <td><?php echo $month_name . ' ' . $selected_year; ?></td>
                                    </tr>
                                    <tr>
            ...
            <div class="col-md-3">
                <div class="card shadow">
                    <div class="card-body text-center">
                        ...
                        <small class="text-muted">
                            <?php echo count($deposits); ?> deposit(s)
                        </small>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card shadow">
                    <div class="card-body text-center">
                        ...
                        <h2 class="text-info"><?php echo $functions->formatCurrency($member_report['meal_rate']); ?></h2>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end"><?php echo number_format($member_report['total_meals'], 2); ?></td>
                                                <td>Sum of my meals for <?php echo $month_name; ?></td>
                                            </tr>
                                            <tr class="table-warning">
                                                <td><strong>My Total Meal Cost</strong></td>
                                                <td class="text-end text-warning"><?php echo $functions->formatCurrency($member_report['member_cost']); ?></td>
                                            ...
                                            <tr class="table-<?php echo $member_report['balance'] >= 0 ? 'success' : 'danger'; ?>">
                                                <td><strong>This Month's Balance</strong></td>
                                                <td class="text-end text-<?php echo $member_report['balance'] >= 0 ? 'success' : 'danger'; ?>">
                                                    <?php echo $functions->formatCurrency($member_report['balance']); ?>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end <?php echo $previous_balance >= 0 ? 'text-success' : 'text-danger'; ?>">
                                                    <?php echo $functions->formatCurrency($previous_balance); ?>
                                                </td>
                                            ...
                                            <tr class="table-<?php echo $adjusted_balance >= 0 ? 'success' : 'danger'; ?>">
                                                ...
                                                <td class="text-end text-<?php echo $adjusted_balance >= 0 ? 'success' : 'danger'; ?>">
                                                    <strong><?php echo $functions->formatCurrency($adjusted_balance); ?></strong>
                                                </td>
                            ...
                            <div class="col-md-4">
                                <div class="card border-info">
                                    ...
                                    <div class="card-body">
                                        ...
                                        $expense_share = ($member_report['house_total_expenses'] > 0) ? 
                                            ($member_cost / $member_report['house_total_expenses']) * 100 : 0;
                                        ?>
                                        ...
                                        <div class="progress mb-3" style="height: 25px;">
                                            <div class="progress-bar bg-info" role="progressbar" 
                                                ...
                                                <?php echo number_format($share_percentage, 1); ?>%
                                            </div>
                                        </div>
                                        ...
                                        <div class="alert alert-info mt-3">
                                            <small>
                                                ...
                                                You consumed <strong><?php echo number_format($share_percentage, 1); ?>%</strong> 
                                                of total meals, so you share <strong><?php echo number_format($expense_share, 1); ?>%</strong> 
                                                of total expenses.
                                            </small>
                                        </div>
                                    </div>
                ...
                <div class="card shadow">
                    <div class="card-header bg-white d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <span class="badge bg-primary ms-1"><?php echo number_format($member_report['total_meals'], 2); ?> meals</span>
                        </div>
                    </div>
                    <div class="card-body">
                        <?php if (!empty($meals)): ?>
                            ...
                            <table class="table table-hover table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr class="<?php echo $meal['meal_count'] == 0 ? 'table-secondary' : ''; ?>">
                                        ...
                                        <td>
                                            ...
                                            <?php if (date('N', strtotime($meal['meal_date'])) >= 6): ?>
                                            <span class="badge bg-warning ms-1">Weekend</span>
                                            <?php endif; ?>
                                        </td>
                                        <td class="text-end">
                                            <?php if ($meal['meal_count'] > 0): ?>
                                            <span class="badge bg-success"><?php echo number_format($meal['meal_count'], 2); ?></span>
                                            <?php else: ?>
                                            <span class="badge bg-secondary">0</span>
                                            <?php endif; ?>
                                        </td>
                                        <td class="text-end text-warning">
                                            <?php echo $functions->formatCurrency($daily_cost); ?>
                                        </td>
                                        <td>
                                            <?php if ($meal['meal_count'] == 0): ?>
                                ...
                                <tfoot class="table-light">
                                    <tr>
                                        ...
                                        <td class="text-end">
                                            <strong><?php echo number_format($member_report['total_meals'], 2); ?> total meals</strong>
                                        </td>
                                        <td class="text-end text-warning">
                                            <strong><?php echo $functions->formatCurrency($total_daily_cost); ?> total</strong>
                                        </td>
                                        <td>
                                            <span class="badge bg-success"><?php echo $days_with_meals; ?> days with meals</span>
                                            <?php if ($days_without_meals > 0): ?>
                                            <span class="badge bg-secondary ms-1"><?php echo $days_without_meals; ?> days without</span>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                </tfoot>
                                ...
                                <div class="card border-success">
                                    <div class="card-body text-center">
                                        ...
                                        <h3 class="text-success">
                                            <?php 
                                            $average_daily = count($meals) > 0 ? $member_report['total_meals'] / count($meals) : 0;
                                ...
                                <div class="card border-warning">
                                    <div class="card-body text-center">
                                        ...
                                        <h3 class="text-warning">
                                            <?php 
                                            $average_daily_cost = $days_with_meals > 0 ? $total_daily_cost / $days_with_meals : 0;
                                            echo $functions->formatCurrency($average_daily_cost);
                                            ?>
                                        </h3>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-end text-success">
                                            <strong><?php echo $functions->formatCurrency($deposit['amount']); ?></strong>
                                        </td>
                                ...
                                <tfoot class="table-light">
                                    <tr>
                                        <td colspan="4" class="text-end">
                                            <h5 class="mb-0">Total Deposits: 
                                                <span class="text-primary"><?php echo $functions->formatCurrency($member_report['total_deposits']); ?></span>
                                            </h5>
                                        </td>
                                    </tr>
                                </tfoot>
                            ...
                            <div class="row text-center">
                                <div class="col-6">
                                    <div class="p-3 border rounded">
                                        ...
                                        <h4 class="text-success">
                                            <?php 
                                            $average_deposit = count($deposits) > 0 ? $member_report['total_deposits'] / count($deposits) : 0;
                                ...
                                <div class="col-6">
                                    <div class="p-3 border rounded">
                                        ...
                                        <h4 class="text-info">
                                            <?php 
                                            $deposit_days = count(array_unique(array_map(function($d) {
                                                return date('Y-m-d', strtotime($d['deposit_date']));
                                            }, $deposits)));
                                            echo $deposit_days . ' days';
                                            ?>
                                        </h4>
                                    </div>
                                </div>
                ...
                <div class="card shadow">
                    <div class="card-header bg-white d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <span class="badge bg-danger ms-1"><?php echo $functions->formatCurrency($member_report['house_total_expenses']); ?></span>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-sm">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <br>
                                            <small class="text-muted">by <?php echo htmlspecialchars($expense['added_by']); ?></small>
                                            <?php endif; ?>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
                                ...
                                <tfoot class="table-light">
                                    <tr>
                                        <td colspan="4" class="text-end">
                                            <h5 class="mb-0">Total Expenses: 
                                                <span class="text-danger"><?php echo $functions->formatCurrency($member_report['house_total_expenses']); ?></span>
                                            </h5>
                                        </td>
                                    </tr>
                                </tfoot>
                            ...
                            <div class="col-md-3 mb-2">
                                <a href="?month=<?php echo $month; ?>&year=<?php echo $year; ?>" 
                                   class="btn btn-outline-primary w-100 text-start <?php echo ($month == $selected_month && $year == $selected_year) ? 'active' : ''; ?>">
                                    ...
                                    <?php echo $month_name_avail . ' ' . $year; ?>
                                </a>
                            </div>
                            <?php endforeach; ?>
                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <div class="alert alert-warning">
                            ...
                            <p class="mb-0">
                                ...
                                <strong class="text-danger">ACTION REQUIRED:</strong> You have a due amount of 
                                <?php echo $functions->formatCurrency(abs($adjusted_balance)); ?>. Please make payment.
                                <?php else: ?>
...
@media print {
    ...
    .btn-group, .alert, .badge:not(.bg-success):not(.bg-danger):not(.bg-warning):not(.bg-info):not(.bg-primary) {
