...
if (!$member_id || !$house_id) {
    die('<div style="padding: 20px; text-align: center; font-family: Arial; color: #dc3545;">
        <h2>Error</h2>
        <p>Invalid parameters specified.</p>
    </div>');
}
...
$member_result = mysqli_stmt_get_result($stmt); // FIX: Get result set
        ...
        <div class="summary-grid">
            ...
            <div class="summary-item">
                ...
                <div class="summary-value">
                    <?php if ($member_report['balance'] >= 0): ?>
                    <span style="color: #27ae60;">IN CREDIT</span>
                    <?php else: ?>
                    <span style="color: #e74c3c;">DUE</span>
                    <?php endif; ?>
                </div>
            </div>
        </div>
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">৳ <?php echo number_format($meal['meal_count'] * $member_report['meal_rate'], 2); ?></td>
                    </tr>
                    <?php endforeach; ?>
                    <tr class="total-row">
                        <td colspan="3" class="text-right"><strong>Total:</strong></td>
                        <td class="text-right"><strong>৳ <?php echo number_format($member_report['member_cost'], 2); ?></strong></td>
                    </tr>
                </tbody>
            </table>
            <?php else: ?>
